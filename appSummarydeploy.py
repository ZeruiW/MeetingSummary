...
def save_summary_in_DB(output_text):
...
def summarize(file, task, inputType, typed_text=None):
...
with gr.Blocks(css=css) as demo:
    ...
    btn.click(
        fn=summarize,
        inputs=[
            file, task, inputType, typed_text,
        ],
